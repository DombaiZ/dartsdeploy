    ...
    useEffect(() => {
        const fecthDarts = async () => {
            try { 
                ...
                console.log("Hiba a lekérdezés közben: ", error);
            }
        }   
        fecthDarts();
    }, [id]);
...
const handleSubmit = event =>{
    ...
    .then(response => {
      if (!response.ok) {
        throw new Error('Hiba történt a kérés feldolgozása alatt');
      }
                    ...
                    <div className="card col-sm3 m-1 p-2">
                        <form onSubmit={handleSubmit}>
                            <div className="form-group row pb-3">
                                <label className="col-sm-3 col-form-label">Dartsos neve:</label>
